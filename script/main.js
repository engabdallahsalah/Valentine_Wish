...
.two {
  ...
  margin-top: 1rem;
  position: relative;
  height: 60px; /* مهم عشان مايحصلش اهتزاز في الصفحة */
}
...
/* ألوان كل سطر */
.line:nth-child(1) { color: #ff4d4d; }
.line:nth-child(2) { color: #ff9933; }
.line:nth-child(3) { color: #33cc33; }
.line:nth-child(4) { color: #3399ff; }
.line:nth-child(5) { color: #9933ff; }
.line:nth-child(6) { 
  color: #ff33cc; 
  font-weight: bold;
  font-size: 1.8rem;
